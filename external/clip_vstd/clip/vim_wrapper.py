...
# Use the minimal Vim model code vendored in this research repo so the baseline
# does not depend on an external Vim source tree.
_VIM_VENDOR_ROOT = Path(__file__).resolve().parents[2] / "vim_vstd"
if str(_VIM_VENDOR_ROOT) not in sys.path:
    sys.path.insert(0, str(_VIM_VENDOR_ROOT))
